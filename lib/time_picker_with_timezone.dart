          ...
          children: <Widget>[
            Padding(
              padding: EdgeInsetsDirectional.only(
                  bottom: _TimePickerModel.useMaterial3Of(context) ? 0 : 4),
...
class _AmPmButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color resolvedBackgroundColor = WidgetStateProperty.resolveAs<Color>(
        timePickerTheme.dayPeriodColor ?? defaultTheme.dayPeriodColor, states);
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        titlePadding:
                            const EdgeInsets.only(top: 16, left: 24, bottom: 0),
                        contentPadding: EdgeInsets.zero,
                        actionsPadding: const EdgeInsets.fromLTRB(8, 0, 8, 8),
                        title: Row(
                          children: [
                            Text(widget.timeZoneTypeTitle ??
                                'Time zone setting'),
                            ...
                            Visibility.maintain(
                              visible: widget.timeZoneHelpIcon != null ||
                                  widget.timeZoneHelpPressed != null,
                              child: IconButton(
                                icon: widget.timeZoneHelpIcon ??
                        ...
                        content: TimeZoneTypeSelectWidget(
                          ...
                          timeZoneTimeTitle: widget.timeZoneTimeTitle,
                          timeZoneSearchIcon: widget.timeZoneSearchIcon,
                          timeZoneSearchHintStyle:
                              widget.timeZoneSearchHintStyle,
                          timeZoneSearchHint: widget.timeZoneSearchHint,
                          removeFromHistoryTitle: widget.removeFromHistoryTitle,
                          removeFromHistoryContent:
                          ...
                          onTimeZoneTypeSelected: (timeZoneType, timeZoneData) {
                            ...
                            widget.onTimeZoneTypeSelected
                                ?.call(timeZoneType, timeZoneData);
                    ...
                    ConstrainedBox(
                      ...
                      child: Text(
                        _timeZoneType == TimeZoneType.fixedTime
                            ? widget.fixedTimeTitle ?? "Fixed time"
                            : TimezoneUtil.timeZoneString(
                                _timeZoneData!, widget.timeZoneShowType!),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
...
class _TimePickerDialogState extends State<TimePickerDialog>
  ...
  // Base sizes
  static const Size _kTimePickerPortraitSize = Size(500, 468);
  static const Size _kTimePickerLandscapeSize = Size(524, 342);
  static const Size _kTimePickerLandscapeSizeM2 = Size(508, 300);
  static const Size _kTimePickerInputSize = Size(450, 216);

  // Absolute minimum dialog sizes, which is the point at which it begins
  // scrolling to fit everything in.
  static const Size _kTimePickerMinPortraitSize = Size(500, 326);
  static const Size _kTimePickerMinLandscapeSize = Size(500, 248);
  static const Size _kTimePickerMinInputSize = Size(500, 196);
  ...
  Size _dialogSize(BuildContext context, {required bool useMaterial3}) {
    ...
    final double textScaleFactor =
        MediaQuery.textScalerOf(context).clamp(maxScaleFactor: 1.1).scale(1.0);
...
Future<TimeWithTimeZone?> showTimeWithTimeZonePicker({
  ...
  assert(initTimeZoneType == TimeZoneType.fixedTime || initTimeZoneData != null,
      "initTimeZoneType=timeZoneTime, initTimeZoneData must not be null");
